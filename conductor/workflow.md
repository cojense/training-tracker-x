...
8. **Complete Task:**
   - Mark the current task in `plan.md` as completed (`[x]`).
...
6. **Conclude Phase Verification:**
   - Announce that the phase verification is complete and all tasks within the phase are verified.
   - Mark the "Conductor - User Manual Verification" task in `plan.md` as completed (`[x]`).
